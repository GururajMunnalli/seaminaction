...
public class CourseList extends EntityQuery<Course> {
	...
	public void setOrder(String order) {
	    String prevOrder = super.getOrder();
	    if ((prevOrder == null && order != null)
            || (prevOrder != null && order == null)
            || (prevOrder != null && !prevOrder.equals(order))) {
            super.setOrder(order);
        }
	    queryState.setOrder(order);
	}
	
	@Override
	public void setFirstResult(Integer firstResult) {
	    Integer prevFirstResult = super.getFirstResult();
	    if ((prevFirstResult == null && firstResult != null
            || (prevFirstResult != null && firstResult == null)
            || (prevFirstResult != null && !prevFirstResult
            .equals(firstResult)))) {
            super.setFirstResult(firstResult);
        }
	    queryState.setFirstResult(firstResult);
	}
...
//	@Factory(value = "courseExample", autoCreate = true, scope = ScopeType.CONVERSATION)
//	public Course createCourseExample() {
//	    return new Course();
//	}
