...
<settings
 ...
 Start JBoss AS. The application will be running at the following URL:
  ...
  http://localhost:8080/grocerylist
 ...
 Now you can either deploy the target/grocerylist.war through the web-based
 GlassFish admininstration console, or you can again use asadmin:

  asadmin /path/to/project/target/grocerylist.war
